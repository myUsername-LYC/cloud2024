...
//            storageFeignApi.decrease(orderFromDB.getProductId(), orderFromDB.getCount());
            ...
            OrderDTO bean = BeanUtil.toBean(orderFromDB, OrderDTO.class);
            System.out.println("bean=" + bean);
            storageFeignApi.decrease1(bean);
